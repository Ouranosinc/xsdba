...
* ``xsdba._processing._adapt_freq`` now avoids inserting nans. This was solved 1) using `dP0 <= 0` and not `dP0 < 0` as a condition; 2) A proper treatment of `dP0` when `P0_hist==0`. (:pull:`239`,:issue:`248`, :pull:`249`).
